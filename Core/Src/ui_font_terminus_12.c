 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --bpp 1 --size 12 --no-compress --stride 1 --align 1 --font TerminusTTF-Bold-4.49.3.ttf --range 32-127,176,192-255,286-287,304-305,350-351,399,601,1024-1119 --format lvgl -o ui_font_terminus_12.c
 ******************************************************************************/
